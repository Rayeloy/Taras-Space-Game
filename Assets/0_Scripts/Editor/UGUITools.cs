...
public class uGUITools : MonoBehaviour
{
    ...
    [MenuItem("uGUI/Anchors to Corners (Recursive) %[")]
    static void AnchorsToCornersRecursive()
    {
        foreach (Transform transform in Selection.transforms)
        {
            RectTransform t = transform as RectTransform;
    ...
    static void AnchorsToCornersRecursive(Transform rectT)
    {
        RectTransform t = rectT as RectTransform;
        RectTransform pt = rectT.parent as RectTransform;
