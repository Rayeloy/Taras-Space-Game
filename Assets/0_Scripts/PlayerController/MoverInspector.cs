...
public class MoverInspector : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        mover.sensorType = (Sensor2D.CastType)EditorGUILayout.EnumPopup("Sensor Type", mover.sensorType);
        ...
        if (mover.sensorType == Sensor2D.CastType.RaycastArray)
            GUILayout.Label("Advanced Options", EditorStyles.centeredGreyMiniLabel);
        GUILayout.Space(5);

        if (mover.sensorType == Sensor2D.CastType.Raycast)
        {
        }
