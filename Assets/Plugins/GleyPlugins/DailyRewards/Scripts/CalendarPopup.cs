namespace GleyDailyRewards
{
    ...
    public class CalendarPopup : MonoBehaviour
    {
        ...
        private void RefreshText()
        {
            ...
            {
                subtitleText.text = I2.Loc.LocalizationManager.GetTranslation("_ui_daily_subtitle_");
                remainingTime.text = CalendarManager.Instance.GetRemainingTime();
            }
            else
            {
                subtitleText.text = I2.Loc.LocalizationManager.GetTranslation("_ui_daily_subtitle_ready_");
                remainingTime.text = I2.Loc.LocalizationManager.GetTranslation("_ui_daily_open_now_");
