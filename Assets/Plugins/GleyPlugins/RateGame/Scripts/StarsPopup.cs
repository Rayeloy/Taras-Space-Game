namespace GleyRateGame
{
    ...
    public class StarsPopup : MonoBehaviour
    {
        ...
        private void Start()
        {
            mainText.text = I2.Loc.LocalizationManager.GetTranslation(RateGame.Instance.RateGameSettings.mainText);
            if (!string.IsNullOrEmpty(RateGame.Instance.RateGameSettings.sendButton))
            {
                sendButton.text = I2.Loc.LocalizationManager.GetTranslation( RateGame.Instance.RateGameSettings.sendButton);
            }
            else
            {
            ...
            {
                notNowButton.text = I2.Loc.LocalizationManager.GetTranslation(RateGame.Instance.RateGameSettings.notNowButton);
            }
            else
            {
        ...
        private void ClosePopup()
        {
            ...
            //GeneralPauseScript.pause.lanzarPopRatingAlReiniciar = false;
