...
//				EditorGUILayout.HelpBox("Use (Tools\\Parse Terms) to find how many times each of the Terms are used", UnityEditor.MessageType.Info);
        ...
        [MenuItem("Tools/I2 Localization/Reimport Localizations %9", false, 16)]
        public static void ReimportLocalizations()
        {
            mLanguageSourceEditor.Import_Google(eSpreadsheetUpdateMode.Replace);
            //UpgradeManager.OpenGlobalSource();
        }
//            //UpgradeManager.OpenGlobalSource();
//            //var newSource = Selection.activeObject as LanguageSourceAsset;
//            //SerializedProperty propSource = serializedObject.FindProperty("mSource");
//            //mLanguageSourceEditor.Custom_OnEnable(newSource.mSource, propSource);
//            //mLanguageSourceEditor.Import_Google(eSpreadsheetUpdateMode.Replace);
//            StopConnectionWWWStatic();
...
//        static void CheckForConnectionStatic()
//        {
...
//        static void StopConnectionWWWStatic()
//        {
//            EditorApplication.update -= CheckForConnection;
...
//        public static bool HasGoogleSpreadsheet()
//        {
